...
namespace Cker
{
    class Program
    {
        ...
        static void Main(string[] args) {
            List<TargetRecord> targets = Parse(@"C:\Users\Robert\Projects\C-Ker", "comp354_vessel.vsf");
            foreach (TargetRecord target in targets) {
                Console.WriteLine(target);
            }

            Console.WriteLine(Simulator.StartTime);
            Console.WriteLine(Simulator.TimeStep);
            Console.WriteLine(Simulator.Time);
            Console.WriteLine(Simulator.Range);
        }
